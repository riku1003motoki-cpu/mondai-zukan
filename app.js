...
function renderEditor(problem) {
  app.innerHTML = `<div class="nav-row"><button class="button" type="button" id="cancelEdit">← 戻る（保存しない）</button><a class="button" href="#/">問題一覧</a></div><form id="editor" class="panel editor"><h1>${esc(problem.collection)}・問題 ${formatNumber(problem.number)} を編集</h1>
